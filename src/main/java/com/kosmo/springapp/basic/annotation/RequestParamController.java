...
/*
	...
	public String requestParamEqual(@RequestParam String name,@RequestParam("years") int age,Model model) {
//	public String requestParamEqual(HttpServletRequest req) {
//		try {
//			String id =  req.getParameter("name");
//			int age = Integer.parseInt(req.getParameter("years"))+10;
//			req.setAttribute("name",id);
//			req.setAttribute("years",age);
...
//		}
		...
		model.addAttribute("years",age+10);
...
*/
	...
	public String error(Model model,Exception e) {
		...
		//방법2]메소드의 인자에 생성된 예외객체를 받는 변수(Exception e)추가
