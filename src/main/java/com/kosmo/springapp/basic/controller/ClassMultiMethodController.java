...
@Controller
public class ClassMultiMethodController {

	@RequestMapping("/Controller/OneClass/List.do")
	public String list(ModelMap model) {
		//데이터 저장]
		model.addAttribute("message", "[목록 요청]");
		//뷰정보 반환
	...
	public String edit(ModelMap model) {
		//데이터 저장]
		model.addAttribute("message", "[수정 요청]");
		//뷰정보 반환
	...
	public String view(ModelMap model) {
		//데이터 저장]
		model.addAttribute("message", "[상세보기 요청]");
		//뷰정보 반환
