...
<div class="container">
	...
	<fieldset>
			...
			<fieldset>
				...
				<li><a href="<c:url value="/Annotation/Lazy.do"/>">@Lazy</a></li>
				
			</fieldset>
			<hr />
			<fieldset>
				<legend>@Configuration 어노테이션 ${message !=null ? message :""}</legend>
				<li><a href="<c:url value="/Annotation/Configuration.do"/>">@Configuration</a></li>
			...
			<fieldset>
				...
				<h4>
					<h5>@RequestBody:JSON 데이터</h5>
					<a href="javascript:send_json()">(JSON 데이터)</a>
					<h5>@RequestBody:FORM 데이터</h5>
...
<script>
	...
	function send_json() {
		$.ajax({
			...
			console.log("받은 데이터 객체[JSON] : " ,dat)
			console.log("서버로 부터 받은 데이터 : 아이디 = " ,dat.user, "비번 = " , dat.pass);
		});
	}
