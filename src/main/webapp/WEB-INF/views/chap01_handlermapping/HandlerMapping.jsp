...
<div class="container">
	...
	<fieldset>
		...
		<ul>
			...
			<li><a href="<c:url value ="/HandlerMapping/Annotattion.do"/>">DefaultAnnotationHandlerMapping</a></li>
		...
		<ul>
			...
			<li><a href="<c:url value ="/HandlerMapping/SimpleUrlFirst.do"/>">SimpleUrlFirstMapping</a></li>
			<li><a href="<c:url value ="/HandlerMapping/SimpleUrlSecond.do"/>">SimpleUrlSecondMapping</a></li>
